...
def pick_attn_implementation(prefer_flash: bool = False) -> str:
    """
    On MPS, disable FlashAttention and SDPA fallbacks.
    """
    return "eager"


def load_model(model_name):
    """Load the vision-language model and processor for MPS."""
    print(f"Loading model: {model_name}")

    # Use float16 or float32 as bfloat16 isn't supported on MPS
