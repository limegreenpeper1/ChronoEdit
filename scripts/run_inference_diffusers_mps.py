...
from chronoedit_diffusers.transformer_chronoedit_mps import ChronoEditTransformer3DModel
from scripts.prompt_enhancer_mps import load_model as load_prompt_enhancer
from scripts.prompt_enhancer_mps import enhance_prompt
...
def calculate_dimensions(image, mod_value, **kwargs):
    """
...
def main():
    ...
    try:
        # Load image encoder (keep in float32 for stability)
        ...
        # Load VAE with appropriate dtype
        ...
        # Load transformer with appropriate dtype
